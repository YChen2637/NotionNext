...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://www.stepheny.top/', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'StephenChen', // 您的昵称 例如
  BIO: process.env.NEXT_PUBLIC_BIO || '编程爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.stepheny.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '自然语言处理, LLM, VLM, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || './public/ico_3.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
