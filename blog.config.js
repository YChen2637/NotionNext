...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Stephen_Chen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我爱干饭🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.stepheny.top/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'NLP, 推荐系统', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/zhuo.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
